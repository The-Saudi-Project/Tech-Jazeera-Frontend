...
const NAV_ITEMS = [
  ...
  },
  {
    to: '/expenses',
    label: 'Expenses',
    // Internal cost data — narrower view circle than Invoices, same as Payroll/EOSB.
    roles: EXPENSE_VIEW_ROLES,
    icon: 'M21 12a2.25 2.25 0 00-2.25-2.25H15a3 3 0 11-6 0H5.25A2.25 2.25 0 003 12m18 0v6a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 18v-6m18 0V9M3 12V9m18 0a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 9m18 0V6.75A2.25 2.25 0 0018.75 4.5H5.25A2.25 2.25 0 003 6.75V9',
  },
  {
    to: '/timesheets',
    label: 'Timesheets',
    // Read-open to all staff (GET /api/timesheets); decide/bulk-approve is Admin/Manager/HR.
  ...
  },
  {
    ...
    // Admin/Manager/HR/Accounts view; computing a new one is Admin/Manager/HR.
    roles: EOSB_VIEW_ROLES,
  ...
  },
  {
    ...
    // Admin/Manager/HR decide; Accounts also handles repayments/payouts.
    roles: FINANCIAL_REQUEST_VIEW_ROLES,
  ...
  },
  {
    ...
    label: 'Coordinator Activity',
    // Oversight: employees/clients Coordinators added themselves.
    roles: COORDINATOR_ACTIVITY_VIEW_ROLES,
