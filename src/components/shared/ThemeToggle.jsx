/**
 * ThemeToggle — sun/moon icon button that flips light/dark via ThemeContext.
 */
...
export default function ThemeToggle({ className = '' }) {
  ...
  return (
    <button
      ...
      className={`rounded-lg p-2 text-muted transition-colors hover:bg-border/40 hover:text-text ${className}`}
    >
      {isDark ? (
